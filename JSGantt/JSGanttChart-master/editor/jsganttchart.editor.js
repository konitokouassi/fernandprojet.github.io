        ...
        this.fieldset = new FieldSetView({
          fields: [
            ...
            },
            {
              ...
              type: "date",
              load: function (model) {
                return model.get("Date de début");
              },
              save: function (model, value) {
            ...
            },
            {
              ...
              type: "Aire texte",
              load: function (model) {
                return JSON.stringify(model.get("icône") || []);
              },
              save: function (model, value) {
                var icône = JSON.parse(value);
                _(icône).each(function (icône) {
                  icône.date = new Date(icône.date);
                });
                return { icône: icône };
              },
            },
